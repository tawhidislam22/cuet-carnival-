    ...
    return (
      <div className="min-h-screen bg-muted/30 flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/dashboard/organizer/manage-events" className="text-sm text-primary hover:underline">
                        ...
                        <tr key={reg.id} className="border-b last:border-0 hover:bg-muted/20 transition-colors">
                          ...
                          <td className="px-4 py-3">
                            <Button
                              size="sm"
                              variant="destructive"
                              onClick={() => { setDeleteError(null); setDeleteTarget(reg); }}
                            >
                              Remove
                            </Button>
                          </td>
        ...
        >
          <div className="mx-4 w-full max-w-sm rounded-xl border bg-background shadow-2xl">
            ...
            <div className="flex gap-3 border-t px-6 py-4">
              ...
              <Button variant="destructive" className="flex-1" onClick={() => void confirmDelete()} disabled={isDeleting}>
