...
import { createEventController, deleteEventController, getEventController, listOrganizerEventsController, listEventsController, registerForEventController, updateEventController, listEventRegistrationsController, deleteEventRegistrationController, uploadEventImageController, eventImageUpload, issueCertificateController, revokeCertificateController, } from "./events.controller.js";
const router = Router();
