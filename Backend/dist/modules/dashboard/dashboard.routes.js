...
import { getAdminEventsController, getAdminOverviewController, getAdminReportsController, getAdminUsersController, getCertificatesController, getDashboardOverviewController, getMyEventsController, getScheduleController, adminToggleEventPublishController, adminDeleteEventController, adminGetEventRegistrationsController, adminSuspendUserController, adminDeleteUserController, adminChangeUserRoleController, adminUpdateEventSettingsController, } from "./dashboard.controller.js";
const router = Router();
