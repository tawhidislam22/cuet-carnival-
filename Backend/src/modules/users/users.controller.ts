...
export async function listOrganizersController(req: Request, res: Response) {
  const userId = req.authUserId;
...
export async function updateOrganizerOnboardingController(req: Request, res: Response) {
  const userId = req.authUserId;
